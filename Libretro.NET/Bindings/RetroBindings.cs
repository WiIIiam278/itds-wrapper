...
namespace Libretro.NET.Bindings
{
    ...
    public static unsafe partial class RetroBindings
    {
        ...
        [DllImport("melondsds_libretro", CallingConvention = CallingConvention.Cdecl, EntryPoint = "retro_deinit", ExactSpelling = true)]
        public static extern void deinit();

        [DllImport("melondsds_libretro", CallingConvention = CallingConvention.Cdecl, EntryPoint = "retro_api_version", ExactSpelling = true)]
        [return: NativeTypeName("unsigned int")]
        public static extern uint api_version();

        [DllImport("melondsds_libretro", CallingConvention = CallingConvention.Cdecl, EntryPoint = "retro_get_system_info", ExactSpelling = true)]
        public static extern void get_system_info([NativeTypeName("struct retro_system_info *")] retro_system_info* info);

        [DllImport("melondsds_libretro", CallingConvention = CallingConvention.Cdecl, EntryPoint = "retro_get_system_av_info", ExactSpelling = true)]
        public static extern void get_system_av_info([NativeTypeName("struct retro_system_av_info *")] retro_system_av_info* info);

        [DllImport("melondsds_libretro", CallingConvention = CallingConvention.Cdecl, EntryPoint = "retro_set_controller_port_device", ExactSpelling = true)]
        ...
        [DllImport("melondsds_libretro", CallingConvention = CallingConvention.Cdecl, EntryPoint = "retro_reset", ExactSpelling = true)]
        public static extern void reset();

        [DllImport("melondsds_libretro", CallingConvention = CallingConvention.Cdecl, EntryPoint = "retro_run", ExactSpelling = true)]
        public static extern void run();

        [DllImport("melondsds_libretro", CallingConvention = CallingConvention.Cdecl, EntryPoint = "retro_serialize_size", ExactSpelling = true)]
        [return: NativeTypeName("size_t")]
        ...
        [DllImport("melondsds_libretro", CallingConvention = CallingConvention.Cdecl, EntryPoint = "retro_cheat_set", ExactSpelling = true)]
        ...
        [DllImport("melondsds_libretro", CallingConvention = CallingConvention.Cdecl, EntryPoint = "retro_load_game", ExactSpelling = true)]
        [return: NativeTypeName("bool")]
        public static extern byte load_game([NativeTypeName("const struct retro_game_info *")] retro_game_info* game);

        [DllImport("melondsds_libretro", CallingConvention = CallingConvention.Cdecl, EntryPoint = "retro_load_game_special", ExactSpelling = true)]
        [return: NativeTypeName("bool")]
        ...
        [DllImport("melondsds_libretro", CallingConvention = CallingConvention.Cdecl, EntryPoint = "retro_unload_game", ExactSpelling = true)]
        public static extern void unload_game();

        [DllImport("melondsds_libretro", CallingConvention = CallingConvention.Cdecl, EntryPoint = "retro_get_region", ExactSpelling = true)]
        [return: NativeTypeName("unsigned int")]
